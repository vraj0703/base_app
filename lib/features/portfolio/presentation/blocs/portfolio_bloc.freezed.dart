...
class _Started implements PortfolioEvent {
  const _Started();
...
class _Initial implements PortfolioState {
  const _Initial();
...
class _Loading implements PortfolioState {
  const _Loading();
...
class _Loaded implements PortfolioState {
  const _Loaded(final  List<ProjectModel> projects): _projects = projects;
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $PortfolioStateCopyWith<$Res> {
...
class _Error implements PortfolioState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $PortfolioStateCopyWith<$Res> {
